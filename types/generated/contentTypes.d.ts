...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    customer_name: Schema.Attribute.String;
    created_time: Schema.Attribute.DateTime;
    tour: Schema.Attribute.Relation<'manyToOne', 'api::tour.tour'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    tour_guides: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiTourGuideTourGuide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    languages_spoken: Schema.Attribute.String;
    tours: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
